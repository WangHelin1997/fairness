...
def main(datadir, savedir, filename):
    audiopath = os.path.join(datadir, filename, filename+'.wav')
    saveaudiopath = os.path.join(savedir, 'Audios', filename+'.wav')
...
if __name__ == '__main__':
    datadir = '/scratch4/lmorove1/hwang258/fairness/data/africandata/Audios/'
    savedir = '/scratch4/lmorove1/hwang258/fairness/data/africandata/'
    filename = '164'
    main(datadir, savedir, filename)
